                ...
                switch (mActionStatus) {
                    case ACTION_EDIT:
                        ...
                        if (isRequiredFieldsEmpty()) {
                            Toast.makeText(this, "Fields title and cost should not be empty", Toast.LENGTH_SHORT).show();
                            break;
                        }
                        if (!isPaymentChanged()) {
                            Toast.makeText(this, "There is no changes", Toast.LENGTH_SHORT).show();
                        } else {
...
//    @Override
//    public void setLastInsertedRow(int lastInsertedRowId) {
//        paymentInitialState = new Payment(paymentCurrentState);
//        paymentInitialState.setId(lastInsertedRowId);
...
//    }
    ...
    public void updateDataFromDB() {
        paymentInitialState = new Payment(paymentCurrentState);
        Toast.makeText(this, "payment has been updated", Toast.LENGTH_SHORT).show();
    }
